...
import {fetchRule} from "../../Action/index"
import {
  BrowserRouter,
  Switch,
  Route,
...
props.getAllRuleAction();
 ...
 if(props.getAllNationEmployee)
  ...
  return (
    <div>
      ...
      return       <Button variant="outlined" size="medium" color="primary" component={Link} to={`/rule/createRule`} >
      Create
    </Button>
 ...
 const mapStateToProps=state=>({
  ...
  getAllRule:state.getAllRule,
})
 const mapDispatchToProps = dispatch => ({
  getAllRuleAction: () => dispatch(fetchRule()),
