...
import {createRegionEmployee, form_r_e_SendConfirm} from '../../../../Action/index';
...
function Content(props) {
  ...
  const data={...props.regionData.employee}
 ...
 dispatch(createRegionEmployee(values.firstName,values.lastName,values.email,values.password,values.useraddress))

 if(props.regionData.isRegister===false){
console.log("is dispaly error")
 }else{
     dispatch(reset("regionEmployeeForm"))
    }
} 
  return (
