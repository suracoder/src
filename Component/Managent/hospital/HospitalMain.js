...
import ChangeTrace from "../../Accidnet/ChangeTrace"
    ...
    {isLoding ? <div>loding</div> : <div>
      ...
      >
        <Tabs value={value} textColor="inherit" onChange={handleChange} >
          {mynewArray1.map(i => {
            if (i.roleName === "hospital" && i.delete)
              return <Tab textColor="inherit" label="View"  {...a11yProps(1)} />
          })}
          {mynewArray1.map(i => {
            if (i.roleName === "hospital" && i.create)
          ...
          {mynewArray1.map(i => {
            if (i.roleName === "hospital" && i.update)
              return <Tab textColor="inherit" label="Update" />
          })}
          {mynewArray1.map(i => {
            if (i.roleName === "hospital" && i.select) {
